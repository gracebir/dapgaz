...
function Offre() {
    return (
        <div className="mx-auto max-w-[1300px] pb-6 flex flex-col items-center gap-14 lg:items-end">
            <h1 className="font-bold text-3xl text-center">Nos vous offrons</h1>
            <div className="bg-[#0000002e] flex flex-col lg:w-[760px] items-center text-[1.5rem] w-[460px] mx-auto text-center px-4 py-4 lg:h-14 lg:flex-row lg:justify-around rounded">
            ...
            <Link className="border border-[#fc7f2a] float-left rounded text-[1.2rem] font-semibold text-[#fc7f2a] px-16 py-3" href="#">Voir +</Link>
        </div>
    )
}
